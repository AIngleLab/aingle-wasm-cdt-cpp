...
​	aingle wasm cdt, support libc/libc++/crypto。blow will list some api not included in this lib.
...
| AINGLE_DISPATCH                      | AINGLE_DISPATCH(oep4, (init)(transfer)(balanceOf)(allowance)) |              | this api just the macro. oep4 here is a contract class name, other are user defined api. and must coding at the last of the main contract file. |
