...
namespace aingle { namespace cdt {
enum sys {
   _linux,
};
...
#define __aingle_OS__ sys::_linux

struct whereami {
   static inline int getExecutablePath(char* out, int capacity, int* dirname_length) {
      return _getExecutablePath<__aingle_OS__>(out, capacity, dirname_length);
   }

   static inline int getModulePath(char* out, int capacity, int* dirname_length) {
      return _getModulePath<__aingle_OS__>(out, capacity, dirname_length);
   }
