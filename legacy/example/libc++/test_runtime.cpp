...
AINGLE_DISPATCH( hello, (transfer)(approve)(transferfrom)(balanceof)(allowance)(tsp)(blkheight) (selfaddr)(calleraddr)(entryaddr)(getinput)(crtblkhash)(crttxhash)(ntf)(callcrt)(crtmigrate)(storageread)(storagewrite)(stogv)(storagedel))
...
void invoke()
{
	...
	address sender 	= aingle::hexstobytes<20>("c238da8b5b6ad3d723dc5d4463346c99d53bcf22");
	address from 	= aingle::hexstobytes<20>("a36963b39d3eb14ddc1a9d016a14256ac594f8a4");
	address to 	= aingle::hexstobytes<20>("b0dc4eca16f06404201b3889b6adc2a6ed0246f4");
	asset val 	= 0x1234;
